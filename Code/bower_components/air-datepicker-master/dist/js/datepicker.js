...
(function (window, $, undefined) {
    ...
    Datepicker.language = {
        ru: {
            ...
            daysShort: ['Sun','Mon','Tus','Wed','Thi','Fri','Sat'],
            daysMin: ['Su','Mo','Tu','We','Th','Fr','Sa'],
            months: ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'Аugust', 'September', 'Оctober', 'November', 'December'],
            monthsShort: ['Jan', 'Feb', 'Мar', 'Аpr', 'Мay', 'Jun', 'Jul', 'Аug', 'Sep', 'Oct', 'Nov', 'Dec'],
            today: 'Monday',
            clear: 'Очистить',
